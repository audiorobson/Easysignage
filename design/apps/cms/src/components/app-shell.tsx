...
/**
 * EasySignage — App Shell (Enterprise)
 * Substitui apps/cms/src/components/app-shell.tsx
 *
 * Mudanças:
 * - Ícones outline via lucide-react (substitui Font Awesome Solid)
 * - Sidebar escura com seções (Operação / Conteúdo / Sistema)
 * - Topbar com indicador de estado da rede e botões de ícone
 *
 * Requer:  pnpm --filter @easysignage/cms add lucide-react
 */
    ...
    <div className="app-shell">
      <aside className="app-sidebar">
        <div className="app-sidebar__brand">
          ...
          <div>
            ...
            <div className="app-sidebar__brand-sub">Network Control</div>
          </div>
        </div>
        ...
        <div className="app-sidebar__user">
          <span className="app-sidebar__avatar" aria-hidden>ES</span>
      ...
      <div className="app-main">
        <header className="app-topbar">
          ...
          <button type="button" className="app-topbar__icon-btn" aria-label="Notificações" title="Em breve">
            <Bell size={18} strokeWidth={1.9} aria-hidden />
            <span className="badge-dot" />
          </button>
          <button type="button" className="app-topbar__icon-btn" aria-label="Ajuda" title="Em breve">
            <CircleHelp size={18} strokeWidth={1.9} aria-hidden />
          </button>
          <button type="button" className="btn btn--ghost" onClick={logout} style={{ marginLeft: 4 }}>
            Sair
          </button>
        </header>
